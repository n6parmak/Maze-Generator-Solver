...
class MazeSolverIDDFS():
    ...
    def DLS(self, start, goal, limit=-1):
        ...
        if found: print("IDDFS total time run ",datetime.now()-self.startT," total expanded cells:",len(visited)+3," optimum path lenght: ",self.maze.optimum); return came_from, visited
